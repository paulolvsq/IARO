...
def pasDeGestion(numIter,numPlayer,listeIters):
    print("Collision en pos : ",listeIters[numIter])
    return listeIters
    ...
    while 1:
        ...
        while i < maxLen:
            ...
            for j in range(nbPlayers): # on fait bouger chaque joueur séquentiellement
                ...
                a = verification_objet((row,col),playerGoal,goalStates,j,posPlayers,score,accObjets,players,wallStates,2,7)
                #if a:
                #    break  
            i+=1
        #print ("scores:", score)
